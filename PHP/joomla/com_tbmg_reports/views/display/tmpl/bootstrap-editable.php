...
JHtml::stylesheet('com_tbmg_reports/bootstrap-editable.css', [], true);
JHtml::script('com_tbmg_reports/bootstrap-editable.js', false, true);
...
<div class="table-responsive">
	<table class='table table-striped table-bordered user-select-none'>
